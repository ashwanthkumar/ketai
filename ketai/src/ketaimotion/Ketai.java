...
import ketaimotion.analyzer.FaceAnalyzer;
import ketaimotion.analyzer.IKetaiAnalyzer;
import ketaimotion.analyzer.MotionAnalyzer;
import ketaimotion.analyzer.SensorAnalyzer;
import ketaimotion.data.DataManager;
import ketaimotion.inputService.CameraService;
import ketaimotion.inputService.LocationService;
import ketaimotion.inputService.SensorService;
import ketaimotion.inputService.KetaiNFC.KetaiNFC;
...
public class Ketai implements IKetaiEventListener, Runnable {
	...
	public void enableSensorManager() {
		inputmanager.addService(new SensorService(parent));
	}

	public void enableCamera() {
		inputmanager.addService(new CameraService(parent, cameraWidth,

...
public class SLIPFrame {
	 ...
	 * the END character used to denote the frame itself.   It is typical that
	 * the END character is sent before transmitting the frame and after transmitting
	 * the frame. 
	 */
	...
	/* utility static method that takes a byte array coming from a SLIP frame
	 * 	in order to "decode" it.  The start/stop END characters should be stripped 
	 *  prior to passing in the frame for processing.  A byte array of the original
